...
public class SystemServiceImpl implements SystemService {
    ...
    public ResponseEntity<Map<String, Object>> addSafetyTalk(SafetyTalkDTO safetyTalk) {
        ...
        newSafetyTalk.setTargetNumber(safetyTalk.getTargetNum());
    ...
    public ResponseEntity<Map<String, Object>> getAllStatusCompany() {
        return getAllData(statusCompanyRepo.findAll());
    }

    @Override
    public ResponseEntity<Map<String, Object>> getDetailStatusCompany(Long id) {
        return getDetailData(id, statusCompanyRepo);
    }
